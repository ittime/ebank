...
public class AdminAction extends Action 
{
	...
	public void removeDeposit (ValueObject depositObject)
	{
		if (depositObject instanceof Deposit)
		{
			Deposit deposit = (Deposit)depositObject; //casting it as a Client object
			_depositManager.closeOrRemove_Deposit(deposit.get_depositId(), _connection, "remove");
		}
		else 
			System.out.println(_error[0]);
	...
	ArrayList<ArrayList<Deposit>> reportDepositListbyType ()
	{
