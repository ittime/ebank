...
//	CONSTANT = 1, FOREIGN = 2, INDEX = 3
	
//	private static final int
//		CONSTANT = 1, FOREIGN = 2, INDEX = 3; //for the switch later
//	
	...
	{
		return ("Deposit ID: "+ _depositId + " / Client ID: " + _clientId + " | " + _interestType + " | Amount: " + _amount + "(estimated amount: "+ (double)(_estimatedAmount) +", final estimated amount: "+ (double) _finalAmount + ")"	+ " from " + formatDate(_openDate) + " to "+ formatDate(_closureDate)
			);
	}
