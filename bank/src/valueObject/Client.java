...
public class Client extends ValueObject {
	...
	public Client(int id, String name, String userName, int password, int phoneNumber,
	...
	public Client(String name, String userName, int password, int phoneNumber,
			String mail, String address, String comments) 
	{
		super();
	...
	public void set_clientUserName(String userName) {
		_clientUserName = userName;
	}
