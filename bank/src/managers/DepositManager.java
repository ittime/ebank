...
public abstract class DepositManager extends Manager {
	...
	public abstract int addDeposit (Deposit deposit, Connection connection, MBank bank);
	...
	protected long calc_ammountOfDays(Calendar openDate, Calendar closureDate) //calculates the amount of days between the opening and the closing of the deposit
	{
	...
	protected double[] calc_estimatedAmmount(String type, int amount, double penalty, long amountOfDays) //calculates the estimated amount and the final estimated amount
	{
	...
	protected double calc_dailyInterest (double interest) // calculate the daily interest (the interest/the amount of days of that year)
	{
	...
	public double decideInterest(String type) {
